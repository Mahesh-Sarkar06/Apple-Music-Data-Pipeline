...
CREATE OR REPLACE STREAMING TABLE bronze.album
...
CREATE OR REPLACE STREAMING TABLE bronze.artist
...
CREATE OR REPLACE STREAMING TABLE bronze.customer
...
CREATE OR REPLACE STREAMING TABLE bronze.employee
...
CREATE OR REPLACE STREAMING TABLE bronze.genre
...
CREATE OR REPLACE STREAMING TABLE bronze.invoice_inline
...
CREATE OR REPLACE STREAMING TABLE bronze.invoice
...
CREATE OR REPLACE STREAMING TABLE bronze.mediatype
...
CREATE OR REPLACE STREAMING TABLE bronze.playlist
...
CREATE OR REPLACE STREAMING TABLE bronze.track
